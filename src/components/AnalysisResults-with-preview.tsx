            ...
            <div className="p-4">
              ...
              <div className="mt-3 text-sm text-gray-600">
                ...
                <ul className="mt-1 space-y-1 text-xs">
                  <li>• <strong>Original mode:</strong> Shows red overlay on sections that will be cut</li>
                  <li>• <strong>Processed mode:</strong> Automatically skips cut sections to preview final result</li>
                  <li>• <strong>Red markers:</strong> Timeline shows exactly where cuts will be made</li>
                </ul>
              </div>
            </div>
          </div>
